...
public class EditorController extends BaseController {
  ...
  // 允许的文件类型
  private static final Map<String, List<String>> VALID_FILE_EXT =
  ...
  public Map<String, Object> upload(MultipartHttpServletRequest request,
    ...
    for (Entry<String, MultipartFile> entry : fileMap.entrySet()) {
      ...
      if (fileSize > MAX_FILE_SIZE) {
        return getError("file size should less than " + MAX_FILE_SIZE + ", current is : "
            + fileSize);
      }
      ...
      String dest =
          completeFormat.format(new Date()) + "_" + random.nextInt(1000) + "." + ext.toLowerCase();
      try {
