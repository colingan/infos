...
public class TemplateUtil {
	public static String getOutputFromStr(String raw, Map<String, Object> params)
	...
	public static String getOutputFromTemplateFile(String fileName,
			Map<String, Object> params) throws IOException, TemplateException {
		Configuration cfg = new Configuration();
		InputStream is = TemplateUtil.class.getClassLoader()
				.getResourceAsStream(fileName);
		cfg.setTemplateLoader(new StringTemplateLoader(IOUtils.toString(is,
				"UTF-8")));
		cfg.setDefaultEncoding("UTF-8");
