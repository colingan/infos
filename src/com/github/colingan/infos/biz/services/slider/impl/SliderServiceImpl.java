...
public class SliderServiceImpl implements SliderService {
	...
	@ConfContextWatch(key = "slider.image.dir", confCenter = Constants.DEFUALT_CONCENTER_FILE, file = Constants.SYSCONF_FILE)
	protected volatile String sliderImageDir;

	@Override
	public boolean updateSlider(long id, int idx, String originName,
			String destName) {
	...
	public List<Slider> queryAllValidateSliders() {
		...
		Condition condition = new ComparisonCondition(Field.IS_DEL,
				Operation.EQ, 0);
		MultiOrderBy orderBy = new MultiOrderBy();
		orderBy.addCommonOrderBy(new CommonOrderBy(Field.IDX,
				OrderByDirection.ASC));
		orderBy.addCommonOrderBy(new CommonOrderBy(Field.UPDATE_TIME,
	...
	public boolean deleteSlider(long id) {
		...
		return this.sliderDao.delete(null, new ComparisonCondition(Field.ID,
				Operation.EQ, id)) == 1;
	}
}
